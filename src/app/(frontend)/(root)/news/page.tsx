...
const categories = ['All', 'Academic', 'Events', 'Arts']
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        {paginatedNews.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <h3 className="mb-2 text-2xl font-bold">No News Yet</h3>
            <p className="text-gray-600">
              {activeCategory === 'All' 
                ? "There are no news articles available at the moment. Please check back later."
                : `There are no news articles in the "${activeCategory}" category. Please try another category.`}
            </p>
          </div>
        )}
